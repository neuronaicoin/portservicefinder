...
// ============================================================
// STATIC PARAMS — Tells Next.js which port slugs to pre-generate
// ============================================================
...
// ============================================================
// METADATA — SEO tags for each port page
// ============================================================
export async function generateMetadata({
  ...
  const description = `Find verified ship agents (${agentCount}), shipchandlers (${chandlerCount}) and marine services (${serviceCount}) at ${portName} Port, ${country}. Free directory for vessel operators, charterers and shipowners. 24/7 maritime services.`;
  ...
  return {
    ...
    keywords: [
      ...
      `${portName} crew change`,
      `ship agency ${portName}`,
      `marine supplier ${portName}`,
      `${country} ship agents`,
    ],
    openGraph: {
      title,
...
export default async function PortPage({
  ...
  const jsonLd = {
    ...
    '@type': 'LocalBusiness',
    name: `Maritime Services in ${portName} Port`,
    description: `Directory of ship agents, shipchandlers and marine services at ${portName}, ${country}`,
    url: `https://www.portservicefinder.com/ports/${portSlug}`,
    address: {
      '@type': 'PostalAddress',
      addressLocality: portName,
    ...
    aggregateRating: providers.length > 0 ? {
      ...
      ratingValue: '4.8',
      reviewCount: providers.length * 12,
    } : undefined,
  };
  ...
  return (
    <>
      ...
      <div style={{
        ...
        {/* HERO */}
        <section className="port-hero" style={{
          ...
          <h1 style={{
            ...
            <span style={{fontSize:'1em'}}>{flag}</span> Ship Agents & Marine Services<br/>
            in <em style={g}>{portName}</em>, {country}
          </h1>
          <p style={{
            fontSize:15,
            lineHeight:1.7,
        ...
        {/* MAIN CONTENT */}
        <div className="port-content" style={{
          maxWidth:1200,
          margin:'0 auto',
          padding:'60px 48px',
        }}>
          ...
          {agents.length > 0 && (
            <section style={{marginBottom:56}}>
              ...
              <p style={{color:'#b0c0a4',fontSize:13,marginBottom:22,lineHeight:1.7}}>
                Verified port agency services at {portName} Port for bulk carriers, tankers, container vessels and general cargo. Specialists in customs clearance, crew change, bunker coordination and pre-arrival documentation.
              </p>
          ...
          {chandlers.length > 0 && (
            <section style={{marginBottom:56}}>
              ...
              <p style={{color:'#b0c0a4',fontSize:13,marginBottom:22,lineHeight:1.7}}>
                Premium ship supply companies serving {portName}. Fresh and frozen provisions, bonded stores, deck and engine spare parts, cabin supplies. 24/7 delivery alongside and to anchorage.
              </p>
              <div className="pgrid" style={{
                display:'grid',
                gridTemplateColumns:'repeat(auto-fill,minmax(320px,1fr))',
          ...
          {services.length > 0 && (
            <section style={{marginBottom:56}}>
              ...
              <p style={{color:'#b0c0a4',fontSize:13,marginBottom:22,lineHeight:1.7}}>
                Technical service companies at {portName}: main engine overhaul, hull and propeller diving, BWTS, electrical, hydraulics, welding, refrigeration. Class-approved by ABS, DNV, Lloyd&apos;s, BV.
              </p>
              <div className="pgrid" style={{
                display:'grid',
                gridTemplateColumns:'repeat(auto-fill,minmax(320px,1fr))',
          ...
          {providers.length === 0 && (
            <section style={{
              ...
              <p style={{color:'#b0c0a4',fontSize:14,marginBottom:18,lineHeight:1.7}}>
                Be the first ship agent, shipchandler or marine service provider at {portName} Port. Get listed on PortServiceFinder — <strong style={g}>1 month free trial</strong>, no card required.
              </p>
          ...
          <section style={{marginBottom:56}}>
            ...
            <div style={{
              ...
              <p style={{marginBottom:14}}>
                {portName} is a key maritime gateway in {country}, serving as an important hub for international trade and shipping operations. Vessels of all types — bulk carriers, container ships, tankers, RoRo and general cargo — call at {portName} for cargo operations, bunker supply, crew change, technical services, and provisions.
              </p>
              <p style={{marginBottom:14}}>
                The port operates around the clock with established port agency services, qualified shipchandlers, and specialized marine service companies. Whether you need pre-arrival documentation, customs clearance, underwater hull cleaning, main engine repair, or fresh provisions, {portName}&apos;s maritime service providers are equipped to handle vessel calls efficiently.
              </p>
              <p>
                PortServiceFinder lists verified, professional service providers at {portName} Port. All listings are free to browse for shipowners, operators, charterers and vessel captains. Service providers can list their business for 1 month free trial.
              </p>
            </div>
          </section>
          ...
          <section style={{marginBottom:56}}>
            ...
            <div style={{display:'flex',flexDirection:'column',gap:14}}>
              {[
                {
                  q:`How do I find a ship agent in ${portName}?`,
                  a:`PortServiceFinder lists ${agents.length} verified ship agent${agents.length!==1?'s':''} at ${portName} Port. Click on any agent's profile above to see their phone, email, WhatsApp and website. Contact them directly — no commission, no booking fees.`,
                },
                {
                  q:`What marine services are available at ${portName}?`,
                  a:`${portName} offers ${offeredServices.size} different marine service categories including main engine repair, underwater diving, electrical, hydraulics, welding, refrigeration, BWTS, bunker supply, crew change logistics, and more. All providers are class-approved and verified.`,
                },
                {
                  q:`Can I get fresh provisions delivered at ${portName} anchorage?`,
                  a:`Yes. ${portName} shipchandlers deliver fresh provisions, bonded stores, deck and engine supplies both alongside and to anchorage. Delivery is typically arranged 24-48 hours in advance through your ship agent or directly with the chandler.`,
                },
                {
                  q:`Is bunker supply available at ${portName}?`,
                  a:`Bunker supply availability depends on the specific port and grade required (VLSFO, MGO, HSFO). Contact a local ship agent or bunker supplier listed above to request a current quote and confirm delivery availability for your vessel.`,
                },
                {
                  q:`How much do port services cost at ${portName}?`,
                  a:`Port costs at ${portName} vary based on vessel type, size, services required and duration. Typical components include agency fee, port dues, pilotage, tugs, mooring, and any additional services. Contact a local ship agent for a detailed disbursement estimate (DA proforma).`,
                },
              ].map((faq,i) => (
                <details key={i} style={{
                  background:'#111c13',
          ...
          <section style={{
            marginTop:56,
            padding:'40px 30px',
            background:'linear-gradient(180deg,rgba(200,168,75,.07),transparent)',
            ...
            <p style={{
              ...
              Get found by shipowners, operators and charterers worldwide. List your business on PortServiceFinder — <strong style={g}>1 month free trial</strong>, no card required, cancel anytime.
            </p>
            <Link href="/" className="btn-gold" style={{
              display:'inline-block',
              background:'#c8a84b',
          ...
          <div className="ftgrid" style={{
            ...
            <div>
              ...
              <p style={{
                ...
                The global maritime services directory. Find ship agents, shipchandlers and marine services at any port worldwide.
              </p>
            ...
            <div>
              ...
              <ul style={{listStyle:'none',display:'flex',flexDirection:'column',gap:7}}>
                ...
                <li><Link href="/" className="port-link" style={{color:'#7a8a72',textDecoration:'none',fontSize:12}}>1 Month Free Trial</Link></li>
              </ul>
            </div>
          </div>
          <div style={{
