...
export const shipAgentFeesPdaExplained: BlogPost = {
  ...
  featuredPort: 'Global',
  metaDescription: 'How much does a ship agent cost in 2026? A detailed breakdown of agency fees, the Proforma Disbursement Account (PDA), pass-through port charges, common hidden costs, and how to negotiate and audit a ship agent invoice.',
  keywords: ['ship agent fees', 'how much does a ship agent cost', 'port agency fees explained', 'disbursement account ship agent', 'PDA proforma disbursement account', 'ship agent invoice', 'port call costs breakdown', 'negotiate ship agent fee', 'FDA final disbursement account'],
  content: `
